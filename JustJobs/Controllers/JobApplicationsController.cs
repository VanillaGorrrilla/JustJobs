...
namespace JustJobs.Controllers
{
    public class JobApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CompanyName,JobDescription,Location,ApplicationDate,ResumePath,Source,Status")] JobApplication jobApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CompanyName,JobDescription,Location,ApplicationDate,ResumePath,Source,Status")] JobApplication jobApplication)
        {
